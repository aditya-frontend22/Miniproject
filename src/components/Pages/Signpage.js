...
function Signpage() {
  return (
    <div>
       <div class="min-w-[100%] min-h-screen bg-gray-200 flex items-center justify-center px-5 py-5 absolute">
    <div class="bg-gray-100 text-gray-500 rounded-3xl shadow-xl w-full overflow-hidden" styles="max-width:1000px">
